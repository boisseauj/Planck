 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl | GUI  | Alt  |Plovr |Digts |    Space    |Accts | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_AZERTY] = LAYOUT_planck_grid(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, PLOVER, DIGITS,   KC_SPC,  KC_SPC,  ACCENTS,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_DIGITS] = LAYOUT_planck_grid(
    ...
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  FR_1,     FR_2,     FR_3,    FR_PIPE,    _______,
...
[_PLOVER] = LAYOUT_planck_grid(
    ...
    PLOVER, XXXXXXX, XXXXXXX, STN_A, STN_O, XXXXXXX, XXXXXXX, STN_E, STN_U, XXXXXXX, XXXXXXX, XXXXXXX
)
};
