...
#define FR_TILD RGUI(FR_EACU) // ~ (dead)
#define FR_HASH RGUI(FR_DQUO) // #
#define FR_LCBR RGUI(FR_QUOT) // {
#define FR_LBRC RGUI(FR_LPRN) // [
#define FR_PIPE RGUI(FR_MINS) // |
#define FR_GRV  RGUI(FR_EGRV) // ` (dead)
#define FR_BSLS RGUI(FR_UNDS) // (backslash)
#define FR_AT   RGUI(FR_AGRV) // @
#define FR_RBRC RGUI(FR_RPRN) // ]
#define FR_RCBR RGUI(FR_EQL)  // }
#define FR_EURO RGUI(KC_E)    // €
#define FR_CURR RGUI(FR_DLR)  // ¤
